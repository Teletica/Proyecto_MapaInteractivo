    ...
    <div class="container mt-5">
        ...
        <div id="formSections">
            ...
            <div id="atracciones" class="form-section">
                            ...
                            <?php if (count($atracciones) > 0): ?>
                                <?php foreach ($atracciones as $atraccion): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <form
                                                action="/Proyecto_MapaInteractivo/Controller/atracciones/AtraccionesEliminar.php"
                                                method="post" style="display:inline;">
                                                <input type="hidden" name="id"
                                                    value="<?php echo htmlspecialchars($atraccion['AtraccionID']); ?>">
                                                <button type="submit" class="btn btn-danger btn-sm">Eliminar</button>
                                            </form>
                                            <button type="button" class="btn btn-warning btn-sm"
                                                onclick="editarAtraccion('<?php echo $atraccion['AtraccionID']; ?>', '<?php echo htmlspecialchars($atraccion['Nombre']); ?>', '<?php echo htmlspecialchars($atraccion['Descripcion']); ?>', '<?php echo htmlspecialchars($atraccion['CantonID']); ?>', '<?php echo htmlspecialchars($atraccion['Tipo']); ?>')">Modificar</button>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            <?php else: ?>
                ...
                <form id="atraccion-form"
                    action="/Proyecto_MapaInteractivo/Controller/atracciones/AtraccionesAgregar.php" method="post">
            ...
            <div id="cantones" class="form-section">
                            ...
                            <?php if (count($cantones) > 0): ?>
                                <?php foreach ($cantones as $canton): ?>
                                    <tr>
                                        ...
                                        <td><img src="<?php echo htmlspecialchars($canton['Img']); ?>" alt="Imagen del Cantón"
                                                style="max-width: 100px; max-height: 100px;"></td>
                                        <td><?php echo htmlspecialchars($canton['Descripcion']); ?></td>
                                        <td>
                                            <form action="/Proyecto_MapaInteractivo/Controller/cantones/CantonesEliminar.php"
                                                method="post" style="display:inline;">
                                                <input type="hidden" name="id"
                                                    value="<?php echo htmlspecialchars($canton['CantonID']); ?>">
                                                <button type="submit" class="btn btn-danger btn-sm">Eliminar</button>
                                            </form>
                                            <button type="button" class="btn btn-warning btn-sm"
                                                onclick="editarCanton('<?php echo $canton['CantonID']; ?>', '<?php echo htmlspecialchars($canton['Nombre']); ?>', '<?php echo htmlspecialchars($canton['ProvinicaID']); ?>', '<?php echo htmlspecialchars($canton['Img']); ?>', '<?php echo htmlspecialchars($canton['Descripcion']); ?>')">Modificar</button>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            <?php else: ?>
                ...
                <form id="canton-form" action="/Proyecto_MapaInteractivo/Controller/cantones/CantonesAgregar.php"
                    method="post">
            ...
            <div id="costumbresindigenas" class="form-section">
                            ...
                            <?php if (count($costumbresindigenas) > 0): ?>
                                <?php foreach ($costumbresindigenas as $costumbre): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <form
                                                action="/Proyecto_MapaInteractivo/Controller/costumbres/CostumbresEliminar.php"
                                                method="post" style="display:inline;">
                                                <input type="hidden" name="costumbre_id"
                                                    value="<?php echo htmlspecialchars($costumbre['CostumbreID']); ?>">
                                                <button type="submit" class="btn btn-danger btn-sm">Eliminar</button>
                                            </form>
                                            <button type="button" class="btn btn-warning btn-sm"
                                                onclick="editarCostumbre('<?php echo $costumbre['CostumbreID']; ?>', '<?php echo htmlspecialchars($costumbre['Nombre']); ?>', '<?php echo htmlspecialchars($costumbre['Descripcion']); ?>', '<?php echo htmlspecialchars($costumbre['GrupoEtnico']); ?>', '<?php echo htmlspecialchars($costumbre['ProvinciaID']); ?>')">Modificar</button>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            <?php else: ?>
                ...
                <form id="costumbre-form" action="/Proyecto_MapaInteractivo/Controller/costumbres/CostumbresAgregar.php"
                    method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="grupo_etnico_costumbre" name="grupo_etnico" class="form-control"
                            required>
                    </div>
                    <div class="form-group">
                        <label for="provincia_id_costumbre">ID de la Provincia:</label>
                        <input type="number" id="provincia_id_costumbre" name="provincia_id" class="form-control"
                            required>
                    </div>
            ...
            <div id="eventos" class="form-section">
                            ...
                            <?php if (count($eventos) > 0): ?>
                                <?php foreach ($eventos as $evento): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <form action="/Proyecto_MapaInteractivo/Controller/eventos/EventosEliminar.php"
                                                method="post" style="display:inline;">
                                                <input type="hidden" name="id"
                                                    value="<?php echo htmlspecialchars($evento['EventoID']); ?>">
                                                <button type="submit" class="btn btn-danger btn-sm">Eliminar</button>
                                            </form>
                                            <button type="button" class="btn btn-warning btn-sm"
                                                onclick="editarEvento('<?php echo $evento['EventoID']; ?>', '<?php echo htmlspecialchars($evento['Nombre']); ?>', '<?php echo htmlspecialchars($evento['Descripcion']); ?>', '<?php echo htmlspecialchars($evento['FechaInicio']); ?>', '<?php echo htmlspecialchars($evento['FechaFin']); ?>', '<?php echo htmlspecialchars($evento['CantonID']); ?>')">Modificar</button>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            <?php else: ?>
                ...
                <form id="evento-form" action="/Proyecto_MapaInteractivo/Controller/eventos/EventosAgregar.php"
                    method="post">
            ...
            <div id="opiniones" class="form-section">
                            ...
                            <?php if (count($opiniones) > 0): ?>
                                <?php foreach ($opiniones as $opinion): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <form action="/Proyecto_MapaInteractivo/Controller/opiniones/OpinionesEliminar.php"
                                                method="post" style="display:inline;">
                                                <input type="hidden" name="id"
                                                    value="<?php echo htmlspecialchars($opinion['OpinionID']); ?>">
                                                <button type="submit" class="btn btn-danger btn-sm">Eliminar</button>
                                            </form>
                                            <button type="button" class="btn btn-warning btn-sm"
                                                onclick="editarOpinion('<?php echo $opinion['OpinionID']; ?>', '<?php echo $opinion['UsuarioID']; ?>', '<?php echo htmlspecialchars($opinion['AtraccionID']); ?>', '<?php echo htmlspecialchars($opinion['Comentario']); ?>', '<?php echo htmlspecialchars($opinion['Calificacion']); ?>')">Modificar</button>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            <?php else: ?>
                ...
                <form id="opinion-form" action="/Proyecto_MapaInteractivo/Controller/opiniones/OpinionesAgregar.php"
                    method="post">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="opinion_texto" name="comentario" class="form-control" rows="4"
                            required></textarea>
                    </div>
                    <div class="form-group">
                        <label for="calificacion_opinion">Calificación:</label>
                        <input type="number" id="calificacion_opinion" name="calificacion" class="form-control" min="1"
                            max="5" required>
                    </div>
            ...
            <div id="provincias" class="form-section">
                            ...
                            <?php if (count($provincias) > 0): ?>
                                <?php foreach ($provincias as $provincia): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <form
                                                action="/Proyecto_MapaInteractivo/Controller/provincias/ProvinciasEliminar.php"
                                                method="post" style="display:inline;">
                                                <input type="hidden" name="id"
                                                    value="<?php echo htmlspecialchars($provincia['ProvinciaID']); ?>">
                                                <button type="submit" class="btn btn-danger btn-sm">Eliminar</button>
                                            </form>
                                            <button type="button" class="btn btn-warning btn-sm"
                                                onclick="editarProvincia('<?php echo $provincia['ProvinciaID']; ?>', '<?php echo htmlspecialchars($provincia['Nombre']); ?>')">Modificar</button>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            <?php else: ?>
                ...
                <form id="provincia-form" action="/Proyecto_MapaInteractivo/Controller/provincias/ProvinciasAgregar.php"
                    method="post">
                    <div class="form-group">
            ...
            <div id="restaurantes" class="form-section">
                            ...
                            <?php if (count($restaurantes) > 0): ?>
                                <?php foreach ($restaurantes as $restaurante): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <form
                                                action="/Proyecto_MapaInteractivo/Controller/restaurantes/RestaurantesEliminar.php"
                                                method="post" style="display:inline;">
                                                <input type="hidden" name="id"
                                                    value="<?php echo htmlspecialchars($restaurante['RestauranteID']); ?>">
                                                <button type="submit" class="btn btn-danger btn-sm">Eliminar</button>
                                            </form>
                                            <button type="button" class="btn btn-warning btn-sm"
                                                onclick="editarRestaurante('<?php echo $restaurante['RestauranteID']; ?>', '<?php echo htmlspecialchars($restaurante['Nombre']); ?>', '<?php echo htmlspecialchars($restaurante['Descripcion']); ?>', '<?php echo htmlspecialchars($restaurante['CantonID']); ?>', '<?php echo htmlspecialchars($restaurante['Tipo']); ?>')">Modificar</button>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            <?php else: ?>
                ...
                <form id="restaurante-form"
                    action="/Proyecto_MapaInteractivo/Controller/restaurantes/RestaurantesAgregar.php" method="post">
                    ...
                    <button type="submit" id="form-button-restaurante" class="btn btn-primary">Agregar
                        Restaurante</button>
                </form>
            </div>
            ...
            <div id="ubicacionesempresas" class="form-section">
                            ...
                            <?php if (count($ubicacionesempresas) > 0): ?>
                                <?php foreach ($ubicacionesempresas as $ubicacion): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <form
                                                action="/Proyecto_MapaInteractivo/Controller/ubicacion/UbicacionEmpresasEliminar.php"
                                                method="post" style="display:inline;">
                                                <input type="hidden" name="id"
                                                    value="<?php echo htmlspecialchars($ubicacion['EmpresaID']); ?>">
                                                <button type="submit" class="btn btn-danger btn-sm">Eliminar</button>
                                            </form>
                                            <button type="button" class="btn btn-warning btn-sm"
                                                onclick="editarUbicacion('<?php echo $ubicacion['EmpresaID']; ?>', '<?php echo htmlspecialchars($ubicacion['Nombre']); ?>', '<?php echo htmlspecialchars($ubicacion['Direccion']); ?>', '<?php echo htmlspecialchars($ubicacion['TipoEmpresa']); ?>', '<?php echo htmlspecialchars($ubicacion['ProvinciaID']); ?>')">Modificar</button>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            <?php else: ?>
                ...
                <form id="ubicacion-form"
                    action="/Proyecto_MapaInteractivo/Controller/ubicacion/UbicacionEmpresasAgregar.php" method="post">
            ...
            <div id="usuarios" class="form-section">
                            ...
                            <?php if (count($usuarios) > 0): ?>
                                <?php foreach ($usuarios as $usuario): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <form action="/Proyecto_MapaInteractivo/Controller/usuarios/UsuariosEliminar.php"
                                                method="post" style="display:inline;">
                                                <input type="hidden" name="id"
                                                    value="<?php echo htmlspecialchars($usuario['UsuarioID']); ?>">
                                                <button type="submit" class="btn btn-danger btn-sm">Eliminar</button>
                                            </form>
                                            <button type="button" class="btn btn-warning btn-sm"
                                                onclick="editarUsuario('<?php echo $usuario['UsuarioID']; ?>', '<?php echo htmlspecialchars($usuario['Nombre']); ?>', '<?php echo htmlspecialchars($usuario['Correo']); ?>', '<?php echo htmlspecialchars($usuario['Contraseña']); ?>', '<?php echo htmlspecialchars($usuario['TipoUsuario']); ?>')">Modificar</button>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            <?php else: ?>
                ...
                <form id="usuario-form" action="/Proyecto_MapaInteractivo/Controller/usuarios/UsuariosAgregar.php"
                    method="post">
                    <div class="form-group">
    ...
    <div class="container-fluid bg-dark text-white py-5 px-sm-3 px-md-5">
        <div class="row pt-5">
            <div class="col-lg-4 col-md-6 mb-5">
                <h5 class="text-primary text-uppercase mb-4" style="letter-spacing: 5px;">Sobre Nosotros</h5>
                <p>Explora los destinos más fascinantes de Costa Rica. Descubre la belleza y diversidad de cada
                    provincia con nosotros.</p>
                <p><i class="fa fa-map-marker-alt mr-2"></i>Costa Rica</p>
                <p><i class="fa fa-phone-alt mr-2"></i>+506 6017 1212</p>
                <p><i class="fa fa-envelope mr-2"></i>info@explorecostarica.com</p>
            ...
            <div class="col-lg-4 col-md-6 mb-5">
                <h5 class="text-primary text-uppercase mb-4" style="letter-spacing: 5px;">Enlaces Rápidos</h5>
                <div class="d-flex flex-column justify-content-start">
                    <a class="text-white mb-2" href="/Proyecto_MapaInteractivo/Vistas/templates/index.php"><i
                            class="fa fa-angle-right mr-2"></i>Inicio</a>
                    <a class="text-white mb-2" href="../templates.provincias/Guanacaste.html"><i
                            class="fa fa-angle-right mr-2"></i>Guanacaste</a>
                    <a class="text-white mb-2" href="../templates.provincias/Limon.php"><i
                            class="fa fa-angle-right mr-2"></i>Limón</a>
                    <a class="text-white mb-2" href="../templates.provincias/Puntarenas.html"><i
                            class="fa fa-angle-right mr-2"></i>Puntarenas</a>
                    <a class="text-white mb-2" href="../templates.provincias/Alajuela.html"><i
                            class="fa fa-angle-right mr-2"></i>Alajuela</a>
                    <a class="text-white mb-2" href="../templates.provincias/SanJose.html"><i
                            class="fa fa-angle-right mr-2"></i>San José</a>
                    <a class="text-white mb-2" href="../templates.provincias/Heredia.php"><i
                            class="fa fa-angle-right mr-2"></i>Heredia</a>
                    <a class="text-white mb-2" href="../templates.layout/Destination.html"><i
                            class="fa fa-angle-right mr-2"></i>Destinos</a>
                    <a class="text-white mb-2" href="../templates.layout/php/cotizar.php"><i
                            class="fa fa-angle-right mr-2"></i>Cotización</a>
                    <a class="text-white mb-2" href="../templates.layout/Administrador.php"><i
                            class="fa fa-angle-right mr-2"></i>Administrador</a>
                    <a class="text-white mb-2" href="login.html"><i class="fa fa-angle-right mr-2"></i>Login</a>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 mb-5">
                <h5 class="text-primary text-uppercase mb-4" style="letter-spacing: 5px;">Mantente Informado</h5>
